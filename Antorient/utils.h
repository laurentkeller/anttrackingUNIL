...
/// Structure defining the position of a tag, a door or something else
struct position{
	int x;///< x coordinate
	int y;///< y coordinate
	position(): x(-1), y(-1){};
...
/**\fn inline double calculate_distance(const double x1, const double y1, const double x2, const double y2)
 * \brief Calculates the distance between 2 points
 * \param x1 X-coordinate of the point 1
 * \param y1 Y-coordinate of the point 1
 * \param x2 X-coordinate of the point 2
 * \param y2 Y-coordinate of the point 2
 * \return Distance (in pixels) between the 2 points
 */
inline double calculate_distance_double(double x1,double y1,double x2,double y2){
